 ...
 */
public class PVFGMyJobsCompletedM extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pvfg_my_jobs_completed_m, container, false);
     ...
     //   generateDummyData();
        ...
        List<MerchantJob> mListed = merchantJobDao.queryBuilder()
                .where(MerchantJobDao.Properties.Jobstatus.eq("closed"))
                .orderAsc(MerchantJobDao.Properties.Name).list();

        merchantJobList.addAll(mListed);

        recyclerView = (RecyclerView)view.findViewById(R.id.rvItem_my_jobs_completed_m);
    ...
    private void generateDummyData() {
        ...
        mj.setJobtitle("Bathroom renew");
        mj.setJobstatus("closed");
        mj.setDistance("100.6 km");
        mj.setName("R 999");
        mj.setTimefinish("1 22 2000");
