 ...
 */
public class PVFGMyJobsContactingM extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pvfg_my_jobs_contacting_m, container, false);
     ...
     //   generateDummyData();
        ...
        List<MerchantJob> mListed = merchantJobDao.queryBuilder()
                .where(MerchantJobDao.Properties.Jobstatus.eq("contacting"))
                .orderAsc(MerchantJobDao.Properties.Name).list();

        merchantJobList.addAll(mListed);

        recyclerView = (RecyclerView)view.findViewById(R.id.rvItem_my_jobs_contacting_m);
    ...
    private void generateDummyData() {
        ...
        mj.setJobtitle("House cleaning");
        mj.setJobstatus("contacting");
        mj.setDistance("2.6 km");
        mj.setName("R 1");
        mj.setTimefinish("6 14 2016");
