...
public class MerchantSvcCatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_merchant_svc_cat);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_merchant_svc_cat);
        setSupportActionBar(toolbar);

        userDefaultManager = new UserDefaultManager(getApplicationContext());

        mListView = (ListView)findViewById(R.id.lv_merchant_svc_cat);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                userDefaultManager.setMerchantField(selectedCategory);

                Intent responseIntent = new Intent();
                responseIntent.putExtra("category", selectedCategory);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_merchant_svc_cat, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_cancel_svc_cat_m) {
            finish();
            return true;
        }
    ...
    private void loadingServiceList() {
        ...
        final String TAG_NET = "LOAD_SERVICE_LIST_JOB_POSTED_M";
