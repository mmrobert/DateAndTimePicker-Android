...
public class UpdateNamePostCodeCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_name_post_code_customer);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_update_name_post_code_c);
        setSupportActionBar(toolbar);

        etUpdateItem = (EditText) findViewById(R.id.et_update_name_post_code_c);

        Intent intent = getIntent();
        requestWhat = intent.getIntExtra("requestWhat", 0);

        if (requestWhat == UPDATE_NAME_C_REQUEST) {
        ...
        } else if (requestWhat == UPDATE_POST_CODE_C_REQUEST) {
        ...
        RelativeLayout rel = (RelativeLayout)findViewById(R.id.content_update_name_post_code_customer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_update_name_post_code_c, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_done_update_name_post_code_c) {
            toDismissKeyboard();
